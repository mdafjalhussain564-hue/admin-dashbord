    ...
    <div className="min-h-screen bg-[#f1f3f8]">
      ...
      >
        ...
        <div className="flex h-[75px] items-center justify-between border-b border-gray-700 px-5">
          ...
          <button
            onClick={() => setSidebarOpen(false)}
            className="text-3xl leading-none text-gray-300 hover:text-white lg:hidden"
          >
            ×
          </button>
      ...
      <main className="lg:ml-[250px]">
        ...
        {/* ================= MOBILE HEADER ================= */}
        <header className="sticky top-0 z-30 flex h-[65px] items-center bg-white px-4 shadow-sm lg:hidden">

          <button
            onClick={() => setSidebarOpen(true)}
            className="flex h-10 w-10 items-center justify-center rounded-md bg-[#191f2d] text-2xl text-white"
          ...
          <div className="flex gap-5">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="mb-4 flex flex-wrap items-center justify-between gap-3 rounded-md bg-white p-4 shadow-sm">
                ...
                <div className="flex gap-3 text-xs text-gray-500 sm:gap-5">
  ...
  return (
    <div
      className={`
        ...
        ${
          listMode
            ? "flex flex-col gap-4 p-4 sm:flex-row sm:items-center sm:gap-5"
            : ""
        }
      `}
    >
      ...
      {/* Wishlist */}
      <button
        className="absolute right-4 top-4 z-10 text-xl text-gray-400 hover:text-red-500"
      >
        ♡
      </button>
      ...
      <div
        className={
          listMode
            ? "h-48 w-full shrink-0 sm:h-32 sm:w-40"
            : "flex h-[190px] items-center justify-center p-5"
        }
      >
